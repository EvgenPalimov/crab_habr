...
urlpatterns = [
    ...
    path('update_post/<slug:slug>/', UpdateArticleView.as_view(),
         name='update_post'),
    path('delete_post/<slug:slug>/', DeleteArticleView.as_view(),
         name='delete_post'),
    path('article/<slug:slug>/', ArticleDetailView.as_view(),
         name='article-detail'),
    path('articles_user_lk/<int:pk>/', ArticlesUserListView.as_view(),
         name='articles_user_lk'),
    path('publish_post/<slug:article_guid>/', publish_post,
         name='publish_post'),
    ...
    path('user_articles/<int:pk>/', AuthorArticles.as_view(),
         name='user_articles'),
