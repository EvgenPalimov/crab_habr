"""
Django settings for crab_habr project.
...
SECRET_KEY = \
    'django-insecure-$$ns#!$a%##&^5q)jhimi(0os0%dm8vy=leq@f#&*o_)5m86@t'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'articles.context_processors.notification_context'
                '.checking_status_notification'
            ],
        },
    },
]

WSGI_APPLICATION = 'crab_habr.wsgi.application'
...
DOMAIN_NAME = 'http://81.200.145.185'
